...
[AEM 6.0 で導入された](https://experienceleague.adobe.com/ja/docs/experience-manager-htl/content/history) HTML テンプレート言語は、AEM での HTML 用にサーバーサイドで優先かつ推奨されるテンプレートシステムです。堅牢なエンタープライズ Web サイトを構築しなければならない Web 開発者にとって、HTL は安全性と開発効率の向上に役立ちます。
...
このビデオでは、HTL を[旧名称の Sightly](https://experienceleague.adobe.com/ja/docs/experience-manager-htl/content/history) と呼んでいます。
...
HTL の目的と利点を理解できたので、HTL 言語の使用を開始できます。詳しくは、[HTML テンプレート言語使用の手引き](https://experienceleague.adobe.com/ja/docs/experience-manager-htl/content/getting-started)を参照してください。
