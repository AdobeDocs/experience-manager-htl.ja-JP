...
description: 可算オブジェクト、Java ベースのオブジェクト、および JavaScript ベースのオブジェクトについて説明します。AEM で使用されるこれらの HTL グローバルオブジェクトの変数名と説明を確認します。
...
| 変数名 | 説明 |
|--- |--- |
| `properties` | 現在の Resource のプロパティのリスト。[org.apache.sling.api.resource.ValueMap](https://helpx.adobe.com/experience-manager/6-5/sites/developing/using/reference-materials/javadoc/org/apache/sling/api/resource/ValueMap.html) によるバックアップ |
